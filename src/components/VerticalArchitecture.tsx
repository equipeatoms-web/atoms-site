      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-24">
          ...
          <h2 className="font-serif text-4xl sm:text-6xl text-foreground mb-6 leading-tight tracking-tight">
            Infraestrutura Vertical <em className="text-primary italic">IA First.</em>
          </h2>
          <p className="text-[16px] text-muted-foreground max-w-xl mx-auto leading-[1.65] font-light">
            Sua empresa não precisa de ferramentas avulsas. Precisa de agentes verticais que recebem o input, geram o ativo, distribuem e cuidam do caixa — integrados na mesma infraestrutura.
          </p>
        </div>
