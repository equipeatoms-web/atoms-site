...
export const MainSolution = () => {
  const steps = [
    { n: "01", title: "Diagnóstico de negócio", desc: "A ATom's senta com você e seu time e mapeia onde a IA paga a conta: gargalo de atendimento, custo por lead, abandono no checkout, retrabalho do time.", deliver: "Mapa de processos + ROI estimado · em 1 semana" },
    { n: "02", title: "Arquitetura Operacional", desc: "Desenhamos a stack pelo seu problema, não pelo hype. Multi-agente quando faz sentido, automação simples quando resolve. Tudo no seu domínio, no seu banco, com seu time no comando.", deliver: "Diagrama + stack + escopo fechado · em 1 semana" },
    { n: "03", title: "Construção e integração", desc: "A ATom's codifica, integra e testa. WhatsApp Cloud, Mercado Pago, Stripe, Google Calendar, n8n, Supabase, ERPs e CRMs que você já usa. Sem reinventar a roda.", deliver: "Produção + 1 fluxo crítico no ar · 2 a 4 semanas" },
    { n: "04", title: "Operação assistida", desc: "Acompanhamos os primeiros 60 dias: métrica, ajuste de prompt, escala de capacidade e treinamento do seu time pra operar com autonomia.", deliver: "Dashboard + 2 ajustes/mês · 60 dias inclusos" },
  ];
